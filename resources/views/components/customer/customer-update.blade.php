...
async function FillUpUpdateForm(id){
    ...
    if(res.data.status === 'success'){
        ...
        errorToast(res.data.message || "Failed to fetch customer!");
    }
}
...
async function Update() {
    ...
    if (!customerName) { errorToast("Customer Name Required!"); return; }
    if (!customerEmail) { errorToast("Customer Email Required!"); return; }
    if (!customerMobile) { errorToast("Customer Mobile Required!"); return; }
